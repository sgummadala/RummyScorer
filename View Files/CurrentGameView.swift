...
// First version  code working without roundscore
import SwiftUI
...
// this version complile but not working  so commenting
//  so commenting the roundscore code in current game
//
/* start of comment for round score verions 2
